...
namespace GraphQL_Intro.Resolver.Mutations
{
    ...
    public class PlayerMutationResolver
    {
        ...
        public async Task<Player> CreatePlayerAsync(PlayerInput playerInput, [Service] IPlayerService playerService)
        {
        ...
        public async Task<Player> UpdatePlayerAsync(int id, PlayerInput playerInput, [Service] IPlayerService playerService)
        {
